...
and excluded from the reading order. The source document's own page numbering is preserved, so
citations to the original still work.
...
column detection is a later phase.
