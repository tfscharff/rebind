...
; it. LICENSE-THIRD-PARTY.txt, DLL-INVENTORY.md and PYTHON-INVENTORY.md are generated by
; scripts/license_inventory.py, which fails if the vendored set and the mapping disagree in either
; direction -- so changing what rebind.spec vendors cannot silently invalidate what this claims.
